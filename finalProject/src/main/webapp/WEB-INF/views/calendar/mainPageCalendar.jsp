...
<script>
  var jb = jQuery.noConflict(); // jquery 충돌
</script>
...
<body>
	  ...
	  <div class="modal-dialog">
	    <div class="modal-content">
	      ...
	      <div class="modal-body">
			...
			<hr>
	      	<form action="updateMain.ca" method="post">
	...
	<form action="selectMain.ca" method="post" id="selectMainCalendarView">
		<input type="hidden" name="memNo" value="${ loginUser.memNo }" >
	</form>
	<script>
		// 이게되나?
		$(document).ready(function(){
			if(${ calendarList }0  == 0){
 				$('#selectMainCalendarView').submit();	
			}
		})
	</script>

	<form action="deleteMain.ca" method="post" id="delete-calendar">
		<input type="hidden" class="cal-no" name="calNo">
		<input type="hidden" name="memNo" value="${ loginUser.memNo }">
		<input type="hidden" class="cal-range" name="calRange">
	</form>
