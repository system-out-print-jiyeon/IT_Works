                ...
                <h1>연락처 추가</h1><br>
                    <table class="address2">                        
                        ...
                        <tr>
                            ...
                            <td><input type="tel" id="phone" size="30"></td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td><input type="tel" id="departmentPhone" size="30"></td>
                        </tr>

                        <tr>
                            <th><label for="spot">직위</label></th> 
                            <td><input type="text" id="spot" size="30"></td>
                        </tr>
                        <tr>
                            <th><label for="email">이메일</label></th> 
                            <td><input type="email" id="email" size="30"></td>
                        </tr>
                        <tr>
                            <th><label for="company">회사명</label></th> 
                            <td><input type="text" id="company" size="30"></td>
                        </tr>
                            
                        <tr>                       
                            <th><label for="Address">주소록 선택</label></th>
                            <td>
                                <input type="radio" id="public" name="Address" value="public">
                                <label for="public">공용 주소록</label> &nbsp;
                                <input type="radio" id="person" name="Address" value="person">
